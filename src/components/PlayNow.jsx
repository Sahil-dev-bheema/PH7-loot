...
function PlayNow() {
  ...
  const totalAmount = selectedTickets.reduce((sum, t) => sum + t.amount, 0);

  // ✅ LOCAL ADD TO CART (NO API)
  const handleAddToCart = () => {
    ...
    // just simulate
    console.log("Added to cart:", selectedTickets);

    navigate("/cart", {
      state: { cartItems: selectedTickets },
    });
  };
